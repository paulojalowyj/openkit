...
### With MASTER.md Rules

- **Prioridade**: `rules/MASTER.md` > intelligent-routing
- Se o MASTER definir roteamento explícito, siga-o
- Intelligent routing é o padrão quando não há instruções específicas
...
Add to `rules/MASTER.md` temporarily:
...
**Next Steps**: Integrate this skill into `rules/MASTER.md` TIER 0 rules.
